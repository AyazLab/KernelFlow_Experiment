...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\zackg\\OneDrive\\Ayaz Lab\\KernelFlow_PsychoPy\\go_no_go - latest\\affective_GNG\\affective_go_no_go_lastrun.py',
...
for thisGNG_loop in GNG_loop:
    ...
    for thisGo_block in go_block:
        ...
        # keep track of which components have finished
        go_trialComponents = [go_trial_text, go_resp, go_image]
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            if go_resp.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > go_resp.tStartRefresh + 3.5-frameTolerance:
                    # keep track of stop time/frame for later
    ...
    for thisGNG_block in GNG_block:
        ...
        # keep track of which components have finished
        GNG_trialComponents = [GNG_trial_text, GNG_trial_resp, GNG_image]
