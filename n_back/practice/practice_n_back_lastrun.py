...
import os
cwd = os.getcwd()
practice_conds_path = os.path.join(cwd, "practice_n_back_conditions")
...
expName = 'practice_n_back'  # from the Builder filename that created this script
...
instructions_text = visual.TextStim(win=win, name='instructions_text',
    text='This is the N-Back task.\n\nYou will be presented a sequence of numbers one-by-one. For each number, you need to decide if the current number is the same as the number presented N trials ago.\n\nThere will be three different tasks: a 0-back, and 1-back, and a 2-back.\n\nPress SPACE to continue.',
    font='Open Sans',
...
n_back_loop = data.TrialHandler(nReps=1.0, method='sequential', 
    ...
    trialList=data.importConditions('practice_NB_TO.csv'),
