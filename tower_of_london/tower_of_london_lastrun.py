...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Sim\\Desktop\\KernelFlow_PsychoPy\\tower_of_london\\tower_of_london_lastrun.py',
...
marker.send_marker(61, task_start_timestamp_fmt)

# Initialize components for Routine "instructions"
instructionsClock = core.Clock()
instructions_text = visual.TextStim(win=win, name='instructions_text',
    text='This is the Tower of London task. \n\nRemember, you must decide if exactly two moves are required to create the Target Board from Your Board. Each colored ball can only be moved to an adjacent peg. \n\nYou will have 7 seconds to study the two boards and 3 seconds to decide your answer.\n\nPress SPACE to continue.',
    font='Open Sans',
...
for thisTOL_loop in TOL_loop:
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if pause_cross.status == STARTED:
            # is it time to stop? (based on global clock, using actual start)
            if tThisFlipGlobal > pause_cross.tStartRefresh + 2.0-frameTolerance:
                # keep track of stop time/frame for later
...
marker.send_marker(62, task_end_timestamp_fmt)
