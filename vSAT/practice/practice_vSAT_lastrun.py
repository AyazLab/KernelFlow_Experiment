...
import os
cwd = os.getcwd()
practice_conds_path = os.path.join(cwd, "practice_vSAT_conditions")
...
expName = 'practice_vSAT'  # from the Builder filename that created this script
...
instructions_text = visual.TextStim(win=win, name='instructions_text',
    text='This is the Visuospatial Sustained Attention (vSAT) Task. \n\nIn a SAT trial, a white square stimulus may or may not briefly appear in the center of the screen followed by a tone. Press RIGHT as soon as you hear the tone if a stimulus appeared. Press LEFT as soon as you hear the tone if a stimulus did not appear.\n\nIn a vSAT trial, a white square stimulus may or may not briefly appear in different locations on the screen followed by a tone. Press RIGHT as soon as you hear the tone if a stimulus appeared. Press LEFT as soon as you hear the tone if a stimulus did not appear.\n\nPress SPACE to continue. ',
    font='Open Sans',
...
experiment_SAT_text = visual.TextStim(win=win, name='experiment_SAT_text',
    text='This is a SAT trial.\n\nRemember, press RIGHT after the tone if a stimulus appeared or press LEFT after the tone if a stimulus did not appear. You will hear a second, higher pitched tone only after a correct response.\n\nPress SPACE to begin.',
    font='Open Sans',
...
main_loop = data.TrialHandler(nReps=1.0, method='sequential', 
    ...
    trialList=data.importConditions('practice_vSAT_TO.csv'),
