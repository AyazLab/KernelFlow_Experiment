...
welcome_text = visual.TextStim(win=win, name='welcome_text',
    text='This is the resting state task. \n\nPlease close your eyes and sit quietly for 7 minutes.\n\nPress SPACE when ready to begin.',
    font='Open Sans',
...
done_text = visual.TextStim(win=win, name='done_text',
    text='The resting state trial is now complete.',
    font='Open Sans',
    pos=(0, 0), height=0.1, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    if trial_text.status == STARTED:
        ...
        if tThisFlipGlobal > trial_text.tStartRefresh + 4.2-frameTolerance:
